...
set -l unwritable_icon (test -n "$tide_pwd_icon_unwritable" &&
    echo "$tide_pwd_icon_unwritable "|| echo '')
set -l home_icon (test -n "$tide_pwd_icon_home" &&
    echo "$tide_pwd_icon_home "|| echo '')
set -l pwd_icon (test -n "$tide_pwd_icon" && echo "$tide_pwd_icon "|| echo '')
